...
export default class extends view {
    ...
    getHtml() {
        return `
            ...
            <div style="color: white" id="content-container">
                ...
                <table style="color: white" class="table table-sm" id="content-fields">
                    ...
                    <tr><th scope="row">Category</th><td id="content-category"></td></tr>
                </table><br>
                <h5>Content data</h5>
                <table style="color: white" class="table table-sm" id="content-fields">
                    <tr><th scope="row">Title</th><td id="content-json-title"></td></tr>
                    <tr><th scope="row">Body</th><td id="content-json-body"></td></tr>
                    <tr><th scope="row">URL</th><td id="content-json-url"></td></tr>
                    <tr><th scope="row">Tags</th><td id="content-json-tags"></td></tr>
                    <tr><th scope="row">Category</th><td id="content-json-category"></td></tr>
                </table><br>                
                <h5>Votes</h5>
                <table style="color: white" class="table table-sm table-striped table-bordered" id="content-votes">
                    <thead><tr>
                ...
                <div id="content-comments">
                    <h5>Comments</h5>
                    <table style="color: white" class="table table-sm table-striped table-bordered">
                        <thead><tr>
    ...
    init() {
        axios.get(config.api + '/content/' + this.contentId).then((content) => {
            ...
            $('#content-json-body').text(content.data.json.body)
            $('#content-json-title').text(content.data.json.title)
            $('#content-json-url').text(content.data.json.url)
            $('#content-json-category').text(content.data.json.category)
            $('#content-json-tags').text(content.data.json.tags)
